...
async function ensureDevServer() {
  try {
    ...
    throw new Error(`ARK dev server is not reachable at ${arkBaseUrl}. Start it with npm.cmd run dev -- --port 5173. ${error instanceof Error ? error.message : String(error)}`);
  }
}
