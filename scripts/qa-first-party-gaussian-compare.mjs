...
async function ensureDevServer() {
  try {
    ...
    throw new Error(`ARK dev server is not reachable at ${targets[0].url}. Start it with npm.cmd run dev -- --port 5173. ${error instanceof Error ? error.message : String(error)}`);
  }
}
